                                ...
                                {currentPageData.length > 0 ? (
                                    currentPageData.map((record, index) => (
                                        <TableRow key={index} className="hover:bg-gray-50">
                                            ...
                                            <TableCell>
                                                <button className="w-fit h-[1.3rem] px-2 rounded-sm bg-blue-400 capitalize font-semibold focus:ring-2 focus:ring-blue-600 ring-offset-1 hover:bg-blue-500 text-white cursor-pointer">
